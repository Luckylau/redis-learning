...
public class CityServiceImpl implements CityService{
    ...
    public City getCity(String cityName) {
        ...
        CityEntity cityEntity =RedisClient.get(jedisTemplate, generateCityCacheKey(cityName), new RedisClient.Loader<String, CityEntity>() {
            @Override
    ...
    public List<City> getAllCity(List<String> citys) {
        ...
        RedisClient.mSet(jedisTemplate, map, 1L, TimeUnit.HOURS);
    ...
    private void deleteCache(String city){
        ...
        RedisClient.delete(jedisTemplate, md5City);
    };
